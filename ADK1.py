...
def usage():
	...
	print 'BAWA KELEM'
	print 'To use windows : ADK1.py <url> '
	print 'To use Linux   : python2 ADK1.py <url> '
	print "\a"
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '=> THE ATTACK OF ATTACKER DEAD KILLER PENYERANGAN DI LAKSANAKAN '
 			print ':) MR.CEKUY ===='
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "PENYERANGAN DI MULAI FULL POWER MR.CEKUY"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
